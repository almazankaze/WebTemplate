...
import AboutImage1 from "../../assets/sample-images/sample1.jpg";
import AboutImage2 from "../../assets/sample-images/sample2.jpg";
    ...
    <div className="container page-container">
      ...
      <div className="about-section">
        ...
        <div className="about-img">
          <img src={AboutImage1} alt="our story" />
        </div>
      </div>

      <div className="about-section about-reverse">
        <div className="about-img">
          <img src={AboutImage2} alt="our mission" />
        </div>
        <div className="about-text">
